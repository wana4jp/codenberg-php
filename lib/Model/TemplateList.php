...
class TemplateList extends ModelBase implements ArrayAccess
{
    /**
    ...
    protected static $types = [
        ...
        'page' => 'int',
        'perPage' => 'int',
        'results' => '\Kanekoelastic\PhpCodenberg\Model\Template[]',
    ];
     ...
     * Sets results.
     *
     * @param \Kanekoelastic\PhpCodenberg\Model\Template[] $results results
     *
     * @return $this
     */
