...
class AuthApi extends ApiBase
{
     ...
     * @throws \Kanekoelastic\PhpCodenberg\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Kanekoelastic\PhpCodenberg\Model\AccessToken, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAccessTokenWithHttpInfo($authorization)
    {
        $returnType = '\Kanekoelastic\PhpCodenberg\Model\AccessToken';
        $request = $this->getAccessTokenRequest($authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Kanekoelastic\PhpCodenberg\Model\AccessToken',
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccessTokenAsyncWithHttpInfo($authorization)
    {
        $returnType = '\Kanekoelastic\PhpCodenberg\Model\AccessToken';
        $request = $this->getAccessTokenRequest($authorization);
     ...
     */
    protected function getAccessTokenRequest($authorization)
    {
