...
class PrefecturesApi extends ApiBase
{
    /**
     ...
     * @throws \Kanekoelastic\PhpCodenberg\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Kanekoelastic\PhpCodenberg\Model\Prefecture, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPrefecturesWithHttpInfo()
    {
        $returnType = '\Kanekoelastic\PhpCodenberg\Model\Prefecture';
        $request = $this->getPrefecturesRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Kanekoelastic\PhpCodenberg\Model\Prefecture',
     ...
     */
    public function getPrefecturesAsync()
    {
        return $this->getPrefecturesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPrefecturesAsyncWithHttpInfo()
    {
        $returnType = '\Kanekoelastic\PhpCodenberg\Model\Prefecture';
        $request = $this->getPrefecturesRequest();
